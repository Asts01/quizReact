...
function AddNewQuiz() {
  ...
  return (
    <div className="flex flex-col items-center justify-between min-h-screen bg-[#DEF9C4] px-5 relative pb-5 overflow-hidden">
      <h1 className="text-4xl font-extrabold text-blue-600 mb-1">Add a New Quiz</h1>

      {questionNo === 3 ? (
        <h2 className="text-xl font-semibold text-center mb-2">Add one more && Your Quiz is All Set To Be Played 🚀🚀🚀</h2>
      ) : (
        <h2 className="text-xl font-semibold text-center mb-2">Add <span className="bg-slate-400 rounded-full p-1 px-2">{4 - questionNo}</span> more questions !!</h2>
      )}

      <div className="w-full max-w-lg bg-white shadow-lg rounded-lg p-8 bg-slate-400 mb-2">
        {questionNo === 1 ? (
          <input
            type="text"
      ...
      <div className="bg-slate-600 text-white text-center py-2 w-full absolute bottom-0">
        Max 3 questions can be added while initially setting up the quiz
      </div>
    </div>
  );
}
...
//   return (
//     <div className='flex flex-col absolute items-center justify-center min-h-screen bg-[#DEF9C4] py-10 px-5'>
...
//         )}
//       </div>
//       <div className='bg-slate-400 w-full fixed bottom-0'>Max 3 questions can be added while initially setting up the quiz</div>
//     </div>
//   );
// }
